...
const features = [
	{
		...
		description:
			"Built on modern technologies like Hono and React for blazing fast performance.",
	},
	{
		icon: "🔐",
	...
	},
	{
		...
		title: "Type-Safe",
		description:
			"End-to-end type safety with TypeScript. From database to frontend, fully typed.",
	},
	{
		icon: "🚀",
		title: "Deploy Anywhere",
		description:
			"Ready for deployment on Vercel, Railway, Zeabur, or any platform you prefer.",
	},
];
		...
		<section className="border-t py-24 md:py-32">
			<div className="container mx-auto px-4">
				<div className="mx-auto max-w-2xl text-center">
					...
					>
						A complete foundation for your next SaaS product. Stop reinventing
						the wheel.
					</motion.p>
				</div>
